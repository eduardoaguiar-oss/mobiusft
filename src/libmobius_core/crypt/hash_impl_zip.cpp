...
hash_impl_zip::get_digest ()
{
    return mobius::core::bytearray {
        std::uint8_t (k0_ >> 24), std::uint8_t (k0_ >> 16),
        std::uint8_t (k0_ >> 8),  std::uint8_t (k0_),
        std::uint8_t (k1_ >> 24), std::uint8_t (k1_ >> 16),
        std::uint8_t (k1_ >> 8),  std::uint8_t (k1_),
        std::uint8_t (k2_ >> 24), std::uint8_t (k2_ >> 16),
        std::uint8_t (k2_ >> 8),  std::uint8_t (k2_),
    };
}
