#ifndef MOBIUS_DECODER_DATA_DECODER_H
#define MOBIUS_DECODER_DATA_DECODER_H
...
public:
  ...
  // Date/time
  // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
  mobius::datetime::datetime get_hfs_datetime ();
  mobius::datetime::datetime get_iso9660_datetime ();
  mobius::datetime::datetime get_nt_datetime ();
  mobius::datetime::datetime get_unix_datetime ();
  mobius::datetime::datetime get_fat_datetime ();
