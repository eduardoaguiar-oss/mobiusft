...
extern "C"
{
    const char *EXTENSION_ID = "os-win";
    const char *EXTENSION_NAME = "Windows OS";
    const char *EXTENSION_VERSION = "1.1";
    const char *EXTENSION_AUTHORS = "Eduardo Aguiar";
    const char *EXTENSION_DESCRIPTION = "Windows OS support";
} // extern "C"
...
start ()
{
    mobius::framework::evidence_processor::
        register_evidence_processor_implementation<
            mobius::extension::os::win::evidence_processor_impl> (
