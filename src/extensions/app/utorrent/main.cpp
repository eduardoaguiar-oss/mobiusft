...
start ()
{
  mobius::core::add_resource (
     "evidence_loader.builder.app-utorrent",
     "uTorrent evidence loader",
     mobius::framework::new_evidence_loader_builder_resource <mobius::extension::app::utorrent::evidence_loader_impl> ()
  );
}
