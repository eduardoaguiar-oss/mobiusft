...
start ()
{
  mobius::core::add_resource (
     "evidence_loader.builder.app-emule",
     "Emule evidence loader",
     mobius::framework::new_evidence_loader_builder_resource <mobius::extension::app::emule::evidence_loader_impl> ()
  );
}
...
stop ()
{
  mobius::core::remove_resource ("evidence_loader.builder.app-emule");
}
