...
extern "C"
{
    const char *EXTENSION_ID = "app-sticky-notes";
    const char *EXTENSION_NAME = "App Sticky Notes";
    const char *EXTENSION_VERSION = "1.1";
    const char *EXTENSION_AUTHORS = "Eduardo Aguiar";
    const char *EXTENSION_DESCRIPTION = "MS Sticky Notes support";
} // extern "C"
...
start ()
{
    mobius::framework::evidence_processor::
        register_evidence_processor_implementation<
            mobius::extension::app::sticky_notes::evidence_processor_impl> (
