...
start ()
{
  mobius::core::add_resource (
     "evidence_loader.builder.app-shareaza",
     "Shareaza evidence loader",
     mobius::framework::new_evidence_loader_builder_resource <mobius::extension::app::shareaza::evidence_loader_impl> ()
  );
}
