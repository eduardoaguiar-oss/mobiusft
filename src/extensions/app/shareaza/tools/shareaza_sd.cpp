...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static void
show_cdownloadsource (
    const mobius::extension::app::shareaza::CDownloadSource &s, int indent)
{
    ...
    std::cout << indent_text << "Last seen time: " << s.get_last_seen_time ()
              << std::endl;
    ...
    std::cout << indent_text << "Protocol ID: " << s.get_protocol_id ()
              << std::endl;
    std::cout << indent_text << "Protocol name: " << s.get_protocol_name ()
              << std::endl;
    std::cout << indent_text << "Country code: " << s.get_country_code ()
              << std::endl;
    std::cout << indent_text << "Country name: " << s.get_country_name ()
              << std::endl;
    std::cout << indent_text << "Server: " << s.get_server () << std::endl;
    std::cout << indent_text << "Server IP: " << s.get_server_ip ()
              << std::endl;
    std::cout << indent_text << "Server port: " << s.get_server_port ()
              << std::endl;
    std::cout << indent_text << "Index: " << s.get_index () << std::endl;
    std::cout << indent_text << "Flag push only: " << s.get_b_push_only ()
              << std::endl;
    std::cout << indent_text << "Flag close conn: " << s.get_b_close_conn ()
              << std::endl;
    std::cout << indent_text << "Flag read content: " << s.get_b_read_content ()
              << std::endl;
    std::cout << indent_text << "Flag hash auth: " << s.get_b_hash_auth ()
              << std::endl;
    std::cout << indent_text << "Flag hash SHA-1: " << s.get_b_hash_sha1 ()
              << std::endl;
    std::cout << indent_text << "Flag hash Tiger: " << s.get_b_hash_tiger ()
              << std::endl;
    std::cout << indent_text << "Flag hash ED2K: " << s.get_b_hash_ed2k ()
              << std::endl;
    std::cout << indent_text << "Flag hash BTH: " << s.get_b_hash_bth ()
              << std::endl;
    std::cout << indent_text << "Flag hash MD5: " << s.get_b_hash_md5 ()
              << std::endl;
    std::cout << indent_text
              << "Flag client extended: " << s.get_b_client_extended ()
              << std::endl;
    std::cout << indent_text << "Flag meta ignore: " << s.get_b_meta_ignore ()
              << std::endl;

    std::cout << indent_text << "Fragments:" << std::endl;
    for (const auto &f : s.get_fragments ())
        std::cout << indent_text << '\t' << f.offset << '\t' << f.size
                  << std::endl;
}
...
show_cbtinfo (const mobius::extension::app::shareaza::CBTInfo &bt, int indent)
{
    ...
    std::cout << indent_text << "Block size: " << bt.get_block_size ()
              << std::endl;
    std::cout << indent_text << "Block count: " << bt.get_block_count ()
              << std::endl;
    std::cout << indent_text << "Total uploaded: " << bt.get_total_uploaded ()
              << std::endl;
    std::cout << indent_text
              << "Total downloaded: " << bt.get_total_downloaded ()
              << std::endl;
    ...
    std::cout << indent_text << "Creation time: " << bt.get_creation_time ()
              << std::endl;
    std::cout << indent_text << "Created by: " << bt.get_created_by ()
              << std::endl;
    std::cout << indent_text << "Flag private: " << bt.get_b_private ()
              << std::endl;
    std::cout << indent_text << "Main tracker: " << bt.get_main_tracker ()
              << std::endl;
    std::cout << indent_text << "Tracker index: " << bt.get_tracker_index ()
              << std::endl;
    std::cout << indent_text << "Tracker mode: " << bt.get_tracker_mode ()
              << std::endl;
    ...
    for (const auto &f : bt.get_files ())
    {
        ...
        std::cout << indent_text << "\tHash SHA-1: " << f.hash_sha1
                  << std::endl;
        std::cout << indent_text << "\tHash ED2K: " << f.hash_ed2k << std::endl;
        std::cout << indent_text << "\tHash Tiger: " << f.hash_tiger
                  << std::endl;
    ...
    for (const auto &t : bt.get_trackers ())
    {
        ...
        std::cout << indent_text << "\tLast access time: " << t.last_access_time
                  << std::endl;
        std::cout << indent_text
                  << "\tLast success time: " << t.last_success_time
                  << std::endl;
        std::cout << indent_text << "\tNext try time: " << t.next_try_time
                  << std::endl;
...
show_sd (const std::string &path)
{
    ...
    std::cout << "\tEstimated size: " << cdownload.get_estimated_size ()
              << std::endl;
    ...
    std::cout << "\tSearch keyword: " << cdownload.get_search_keyword ()
              << std::endl;
    ...
    std::cout << "\tTorrent success: " << cdownload.get_torrent_success ()
              << std::endl;
    std::cout << "\tServing file name: " << cdownload.get_serving_file_name ()
              << std::endl;
...
main (int argc, char **argv)
{
    ...
    {
        std::cout << std::endl;
        std::cout << "Error: you must enter at least one path to .sd file"
                  << std::endl;
        usage ();
        exit (EXIT_FAILURE);
    }
