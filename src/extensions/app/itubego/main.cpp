...
extern "C"
{
    const char *EXTENSION_ID = "app-itubego";
    const char *EXTENSION_NAME = "iTubeGo Downloader";
    const char *EXTENSION_VERSION = "1.1";
    const char *EXTENSION_AUTHORS = "Eduardo Aguiar";
    const char *EXTENSION_DESCRIPTION = "iTubeGo Downloader support";
} // extern "C"
...
start ()
{
    mobius::framework::evidence_processor::
        register_evidence_processor_implementation<
            mobius::extension::app::itubego::evidence_processor_impl> (
