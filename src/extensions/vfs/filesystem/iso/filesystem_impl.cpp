...
filesystem_impl::_load_data () const
{
    ...
    decoder.skip (1);
    auto system_id =
        mobius::core::string::strip (decoder.get_string_by_size (32));
    auto volume_id =
        mobius::core::string::strip (decoder.get_string_by_size (32));
    decoder.skip (8);
    ...
    decoder.skip (36);
    auto volume_set_id =
        mobius::core::string::strip (decoder.get_string_by_size (128));
    auto publisher_id =
        mobius::core::string::strip (decoder.get_string_by_size (128));
    auto data_preparer_id =
        mobius::core::string::strip (decoder.get_string_by_size (128));
    auto application_id =
        mobius::core::string::strip (decoder.get_string_by_size (128));
    auto copyright_file_id =
        mobius::core::string::strip (decoder.get_string_by_size (37));
    auto abstract_file_id =
        mobius::core::string::strip (decoder.get_string_by_size (37));
    auto bibliographic_file_id =
        mobius::core::string::strip (decoder.get_string_by_size (37));
