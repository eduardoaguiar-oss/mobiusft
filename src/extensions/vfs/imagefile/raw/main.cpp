...
extern "C"
{
    const char *EXTENSION_ID = "imagefile-raw";
    const char *EXTENSION_NAME = "Raw image file";
    const char *EXTENSION_VERSION = "1.1";
    const char *EXTENSION_AUTHORS = "Eduardo Aguiar";
    const char *EXTENSION_DESCRIPTION = "Raw image file support";
} // extern "C"
...
start ()
{
    mobius::core::add_resource (
        "vfs.imagefile.raw", "Raw image file",
...
stop ()
{
    mobius::core::remove_resource ("vfs.imagefile.raw");
}
