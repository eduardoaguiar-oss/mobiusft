...
extern "C"
{
    const char *EXTENSION_ID = "imagefile-solo";
    const char *EXTENSION_NAME = "ICS Solo image file";
    const char *EXTENSION_VERSION = "1.2";
    const char *EXTENSION_AUTHORS = "Eduardo Aguiar";
    const char *EXTENSION_DESCRIPTION = "ICS Solo image file support";
} // extern "C"
...
start ()
{
    mobius::core::add_resource (
        "vfs.imagefile.solo", "ICS Solo image file",
...
stop ()
{
    mobius::core::remove_resource ("vfs.imagefile.solo");
}
