...
class MediaView(object):
    ...
    def __init__(self):
        ...
        self.name = f'{EXTENSION_NAME} v{EXTENSION_VERSION} - Media Generator'
        ...
        for r in mobius.core.get_resources('report-template'):
            ...
            for template in generator.templates:
                ...
                if t_type == 'media':
                    self.__template_model.append([media_icon, t_id, t_type, t_description, generator])
    ...
    def __update_options(self):
        ...
        self.__generate_hashes_check.set_sensitive(is_media)
