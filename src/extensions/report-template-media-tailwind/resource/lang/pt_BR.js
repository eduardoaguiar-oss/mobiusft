...
const LANG = {
  ...
  "column.call.source":"De",
  "column.call.destination":"Para",
  "column.chat-message.sender":"De",
  "column.chat-message.recipients":"Para",
  ...
  "column.password-hash.password_hash_type":"Tipo",
  ...
  "report.menuitem.artifacts":"Vestígios Digitais",
  "report.menuitem.info":"Informações do Item",
  "report.menuitem.metadata":"Metadados do Item",
  "report.menuitem.ufdr":"Dados da extração do UFDR",
  "report.menuitem.vfs":"Sistema Virtual de Arquivos (VFS)",
  "report.panel.case_info":"Informações do Item",
  "report.panel.evidences":"Evidências Digitais",
  "report.panel.artifacts":"Vestígios Digitais",
  "report.panel.ufdr":"Dados da extração obtidos do arquivo .UFDR",
  "report.panel.vfs":"Sistema Virtual de Arquivos (VFS)",
  "report.section.artifacts":"Vestígios Digitais",
  ...
  "text.artifact_type":"Tipo de Vestígio",
  "text.evidence_type":"Tipo de Evidência",
  "text.extraction":"Extração",
  "text.general_info":"Informações Gerais",
  "text.loading_artifacts":"Carregando vestígios digitais...",
  "text.loading_metadata":"Carregando metadados do item...",
  "text.loading_vfs":"Carregando dados do VFS...",
  "text.no_items":"Nenhum item carregado",
  "text.no_metadata":"Nenhum metadado encontrado",
  "text.property":"Atributo",
  "text.select_block":"Selecione um bloco para visualizar os metadados",
  "text.select_artifact_type":"Selecione o tipo de vestígio digital para visualizar a lista",
  "text.select_evidence_type":"Selecione o tipo de vestígio digital para visualizar a lista",
