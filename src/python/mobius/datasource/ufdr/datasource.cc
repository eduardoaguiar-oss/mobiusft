...
{
  return mobius::py::isinstance (value, &datasource_ufdr_datasource_t);
}
...
tp_f_set_case_info (datasource_ufdr_datasource_o *self, PyObject *args)
{
  ...
  try
    {
      arg_case_info = mobius::py::get_arg_as_cpp (args, 0, pymobius_pod_map_from_pyobject);
    }
  catch (const std::exception& e)
    {
...
tp_f_add_extraction (datasource_ufdr_datasource_o *self, PyObject *args)
{
  ...
  try
    {
      arg_extraction = mobius::py::get_arg_as_cpp (args, 0, pymobius_datasource_ufdr_extraction_from_pyobject);
    }
  catch (const std::exception& e)
    {
      mobius::py::set_invalid_type_error (e.what ());
  ...
  try
    {
      ret = mobius::py::pylist_from_cpp_container (
               ...
               pymobius_datasource_ufdr_extraction_to_pyobject
            );
    }
  catch (const std::exception& e)
    {
...
static PyMethodDef tp_methods[] =
{
  {
    (char *) "get_url",
    (PyCFunction) tp_f_get_url,
    METH_VARARGS,
    "Get .ufdr URL"
  },
  {
    (char *) "get_file_info",
    (PyCFunction) tp_f_get_file_info,
    METH_VARARGS,
    "Get .ufdr file info"
  },
  {
    (char *) "get_case_info",
    (PyCFunction) tp_f_get_case_info,
    METH_VARARGS,
    "Get case info"
  },
  {
    (char *) "set_case_info",
    (PyCFunction) tp_f_set_case_info,
    METH_VARARGS,
    "Set case info"
  },
  {
    (char *) "add_extraction",
    (PyCFunction) tp_f_add_extraction,
    METH_VARARGS,
    "Add extraction"
  },
  {
    (char *) "get_extractions",
    (PyCFunction) tp_f_get_extractions,
    METH_VARARGS,
    "Get extractions"
  },
...
PyTypeObject datasource_ufdr_datasource_t =
{
  ...
  "mobius.datasource.ufdr.datasource",     		// tp_name
  sizeof (datasource_ufdr_datasource_o),   		// tp_basicsize
  0,                                       		// tp_itemsize
