...
func_framework_has_config (PyObject *, PyObject *args)
{
  ...
  try
    {
      ret = mobius::py::pybool_from_bool (mobius::framework::has_config (arg_name));
    }
  catch (const std::exception& e)
    {
...
func_framework_get_config (PyObject *, PyObject *args)
{
  ...
  try
    {
      ret = pymobius_pod_data_to_python (mobius::framework::get_config (arg_name));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
func_framework_new_config_transaction (PyObject *, PyObject *)
{
  ...
  try
    {
      ret = pymobius_database_transaction_to_pyobject (mobius::framework::new_config_transaction ());
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
