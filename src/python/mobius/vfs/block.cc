...
{
  return mobius::py::isinstance (value, &vfs_block_t);
}
...
tp_f_add_parent (vfs_block_o *self, PyObject *args)
{
  ...
  try
    {
      arg_parent = mobius::py::get_arg_as_cpp (args, 0, pymobius_vfs_block_from_pyobject);
    }
  catch (const std::exception& e)
    {
      mobius::py::set_invalid_type_error (e.what ());
...
tp_f_get_attribute (vfs_block_o *self, PyObject *args)
{
  ...
  try
    {
      ret = pymobius_pod_data_to_pyobject (self->obj->get_attribute (arg_name));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_f_new_slice_block (vfs_block_o *self, PyObject *args)
{
  ...
  try
    {
      ret = pymobius_vfs_block_to_pyobject (
...
static PyMethodDef tp_methods[] =
{
  ...
  {
    (char *) "add_parent",
    (PyCFunction) tp_f_add_parent,
    METH_VARARGS,
    "Add parent"
  },
  {
    (char *) "get_parents",
    (PyCFunction) tp_f_get_parents,
    METH_VARARGS,
    "Get parents"
  },
  {
  ...
  {
    (char *) "is_handled",
    (PyCFunction) tp_f_is_handled,
    METH_VARARGS,
    "Is block handled"
  },
  {
    (char *) "set_handled",
    (PyCFunction) tp_f_set_handled,
    METH_VARARGS,
    "Set handled flag"
  },
  {
    (char *) "is_complete",
    (PyCFunction) tp_f_is_complete,
    METH_VARARGS,
    "Is block complete"
  },
  {
    (char *) "set_complete",
    (PyCFunction) tp_f_set_complete,
    METH_VARARGS,
    "Set complete flag"
  },
  {
  ...
  {
    (char *) "set_available",
    (PyCFunction) tp_f_set_available,
    METH_VARARGS,
    "Set available flag"
  },
  {
  ...
  {
    (char *) "new_slice_block",
    (PyCFunction) tp_f_new_slice_block,
    METH_VARARGS,
    "Create new slice block"
  },
...
PyTypeObject vfs_block_t =
{
  ...
  "mobius.vfs.block",                      		// tp_name
  sizeof (vfs_block_o),                    		// tp_basicsize
  0,                                       		// tp_itemsize
