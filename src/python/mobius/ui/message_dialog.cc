...
tp_getter_informative_text (ui_message_dialog_o *self)
{
  ...
  try
    {
      ret = mobius::py::pystring_from_std_string (self->obj->get_informative_text ());
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_setter_informative_text (ui_message_dialog_o *self, PyObject *value, void *)
{
  ...
  try
    {
      self->obj->set_informative_text (mobius::py::pystring_as_std_string (value));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
static PyGetSetDef tp_getset[] =
{
  ...
  },
  {
    ...
    (setter) tp_setter_title,
    (char *) "Window's title",
    NULL
  },
  {
    (char *) "text",
    (getter) tp_getter_text,
    (setter) tp_setter_text,
    (char *) "Text",
    NULL
  },
  {
    (char *) "informative_text",
    (getter) tp_getter_informative_text,
    (setter) tp_setter_informative_text,
    (char *) "Informative text",
    NULL
  },
...
static PyMethodDef tp_methods[] =
{
  {
    (char *) "add_button",
    (PyCFunction) tp_f_add_button,
    METH_VARARGS,
    "Add button"
  },
  {
    (char *) "set_default_response",
    (PyCFunction) tp_f_set_default_response,
    METH_VARARGS,
    "Set default response"
  },
  {
    (char *) "run",
    (PyCFunction) tp_f_run,
    METH_VARARGS,
    "Run dialog"
  },
...
tp_new (PyTypeObject *type, PyObject *args, PyObject *)
{
  ...
  ui_message_dialog_o *ret = reinterpret_cast <ui_message_dialog_o *> (type->tp_alloc (type, 0));
...
PyTypeObject ui_message_dialog_t =
{
  ...
  "mobius.ui.message_dialog",              		// tp_name
  sizeof (ui_message_dialog_o),            		// tp_basicsize
  0,                                       		// tp_itemsize
...
{
  mobius::py::pytypeobject type (&ui_message_dialog_t);
  type.create ();
...
{
  return PyObject_IsInstance (value, reinterpret_cast<PyObject *> (&ui_message_dialog_t));
}
...
pymobius_ui_message_dialog_from_pyobject (PyObject *value)
{
  if (!pymobius_ui_message_dialog_check (value))
    throw std::invalid_argument (mobius::MOBIUS_EXCEPTION_MSG ("object must be an instance of mobius.ui.message_dialog"));
