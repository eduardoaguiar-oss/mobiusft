...
{
  return PyObject_IsInstance (pyobj, (PyObject *) &io_uri_t);
}
...
tp_f_get_path (io_uri_o *self, PyObject *args)
{
  ...
  try
    {
      ret = mobius::py::pystring_from_std_string (self->obj->get_path (arg_encoding));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_f_get_query (io_uri_o *self, PyObject *args)
{
  ...
  try
    {
      ret = mobius::py::pystring_from_std_string (self->obj->get_query (arg_encoding));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_f_get_fragment (io_uri_o *self, PyObject *args)
{
  ...
  try
    {
      ret = mobius::py::pystring_from_std_string (self->obj->get_fragment (arg_encoding));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_f_get_parent (io_uri_o *self, PyObject *)
{
  ...
  try
    {
      ret = pymobius_io_uri_to_pyobject (self->obj->get_parent ());
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_f_get_sibling_by_name (io_uri_o *self, PyObject *args)
{
  ...
  try
    {
      ret = pymobius_io_uri_to_pyobject (self->obj->get_sibling_by_name (arg_filename));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_f_get_sibling_by_extension (io_uri_o *self, PyObject *args)
{
  ...
  try
    {
      ret = pymobius_io_uri_to_pyobject (self->obj->get_sibling_by_extension (arg_extension));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_f_get_child_by_name (io_uri_o *self, PyObject *args)
{
  ...
  try
    {
      ret = pymobius_io_uri_to_pyobject (self->obj->get_child_by_name (arg_name));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_f_get_child_by_path (io_uri_o *self, PyObject *args)
{
  ...
  try
    {
      ret = pymobius_io_uri_to_pyobject (self->obj->get_child_by_path (arg_subpath));
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
static PyMethodDef tp_methods[] =
{
  ...
  {
    (char *) "get_scheme",
    (PyCFunction) tp_f_get_scheme,
    METH_VARARGS,
    "Get scheme"
  },
  {
    (char *) "get_authority",
    (PyCFunction) tp_f_get_authority,
    METH_VARARGS,
    "Get authority"
  },
  {
  ...
  {
    (char *) "get_query",
    (PyCFunction) tp_f_get_query,
    METH_VARARGS,
    "Get query"
  },
  {
    (char *) "get_fragment",
    (PyCFunction) tp_f_get_fragment,
    METH_VARARGS,
    "Get fragment"
  },
  {
    (char *) "get_username",
    (PyCFunction) tp_f_get_username,
    METH_VARARGS,
    "Get user name"
  },
  {
    (char *) "get_password",
    (PyCFunction) tp_f_get_password,
    METH_VARARGS,
    "Get password"
  },
  {
    (char *) "get_host",
    (PyCFunction) tp_f_get_host,
    METH_VARARGS,
    "Get host"
  },
  {
    (char *) "get_port",
    (PyCFunction) tp_f_get_port,
    METH_VARARGS,
    "Get port"
  },
  {
  ...
  {
    (char *) "is_empty",
    (PyCFunction) tp_f_is_empty,
    METH_VARARGS,
    "Check if URI is empty"
  },
  {
    (char *) "is_relative",
    (PyCFunction) tp_f_is_relative,
    METH_VARARGS,
...
tp_new (PyTypeObject *type, PyObject *args, PyObject *)
{
  ...
  io_uri_o *ret = reinterpret_cast <io_uri_o *> (type->tp_alloc (type, 0));
...
PyTypeObject io_uri_t =
{
  ...
  "mobius.io.uri",                         		// tp_name
  sizeof (io_uri_o),                       		// tp_basicsize
  0,                                       		// tp_itemsize
