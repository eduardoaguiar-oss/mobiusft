#ifndef MOBIUS_PYTHON_IO_TEXT_WRITER_H
#define MOBIUS_PYTHON_IO_TEXT_WRITER_H
...
PyObject *pymobius_io_text_writer_to_pyobject (const mobius::io::text_writer&);
