...
{
  return PyObject_IsInstance (value, reinterpret_cast<PyObject *> (&os_win_trashbin_info2_file_t));
}
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
PyObject *
pymobius_os_win_trashbin_info2_file_to_pyobject (const mobius::core::os::win::trashbin::info2_file& obj)
{
  PyObject *ret = _PyObject_New (&os_win_trashbin_info2_file_t);

  if (ret)
    ((os_win_trashbin_info2_file_o *) ret)->obj = new mobius::core::os::win::trashbin::info2_file (obj);
...
tp_getter_number_of_files (os_win_trashbin_info2_file_o *self)
{
  ...
  try
    {
      ret = mobius::py::pylong_from_std_int32_t (self->obj->get_number_of_files ());
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_getter_last_file_idx (os_win_trashbin_info2_file_o *self)
{
  ...
  try
    {
      ret = mobius::py::pylong_from_std_int32_t (self->obj->get_last_file_idx ());
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
...
tp_getter_record_size (os_win_trashbin_info2_file_o *self)
{
  ...
  try
    {
      ret = mobius::py::pylong_from_std_uint32_t (self->obj->get_record_size ());
    }
  catch (const std::exception& e)
    {
      mobius::py::set_runtime_error (e.what ());
  ...
  try
    {
      ret = mobius::py::pylist_from_cpp_container (
               *(self->obj),
               pymobius_os_win_trashbin_info2_entry_to_pyobject
            );
    }
  catch (const std::exception& e)
    {
...
static PyGetSetDef tp_getset[] =
{
  ...
  },
  {
    ...
    (getter) tp_getter_number_of_files,
    (setter) 0,
    (char *) "Number of files",
    NULL
  },
  {
    (char *) "last_file_idx",
    (getter) tp_getter_last_file_idx,
    (setter) 0,
    (char *) "Last file index",
    NULL
  },
  {
    (char *) "record_size",
    (getter) tp_getter_record_size,
    (setter) 0,
    (char *) "Record size",
    NULL
  },
...
tp_new (PyTypeObject *type, PyObject *args, PyObject *)
{
  ...
  os_win_trashbin_info2_file_o *ret = reinterpret_cast <os_win_trashbin_info2_file_o *> (type->tp_alloc (type, 0));

  if (ret)
    {
      try
        {
          ret->obj = new mobius::core::os::win::trashbin::info2_file (arg_reader);
        }
      catch (const std::exception& e)
        {
          Py_DECREF (ret);
...
PyTypeObject os_win_trashbin_info2_file_t =
{
  ...
  "mobius.os.win.trashbin.info2_file",     		// tp_name
