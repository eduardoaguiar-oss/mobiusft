...
{
  return mobius::py::isinstance (value, &crypt_cipher_t);
}
...
static PyMethodDef tp_methods[] =
{
  {
    (char *) "is_stream",
    (PyCFunction) tp_f_is_stream,
    METH_VARARGS,
    "Return true if it is a cipher stream algorithm"
  },
  {
    (char *) "is_block",
    (PyCFunction) tp_f_is_block,
    METH_VARARGS,
  ...
  {
    (char *) "authenticate",
    (PyCFunction) tp_f_authenticate,
    METH_VARARGS,
    "Authenticate data"
  },
  {
    (char *) "get_tag",
    (PyCFunction) tp_f_get_tag,
    METH_VARARGS,
    "Get authentication tag"
  },
  {
    (char *) "check_tag",
    (PyCFunction) tp_f_check_tag,
    METH_VARARGS,
