#ifndef LIBMOBIUS_PYTHON_CORE_UI_STACKED_CONTAINER_HPP
#define LIBMOBIUS_PYTHON_CORE_UI_STACKED_CONTAINER_HPP
...
typedef struct
{
    PyObject_HEAD mobius::core::ui::stacked_container *obj;
