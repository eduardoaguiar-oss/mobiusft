...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyTypeObject core_ui_stacked_container_t = {
    PyVarObject_HEAD_INIT (nullptr, 0)        // header
    "mobius.core.ui.stacked_container",       // tp_name
    sizeof (core_ui_stacked_container_o),     // tp_basicsize
    0,                                        // tp_itemsize
...
{
    mobius::py::pytypeobject type (&core_ui_stacked_container_t);
    type.create ();
...
{
    return mobius::py::isinstance (value, &core_ui_stacked_container_t);
}
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
PyObject *
pymobius_core_ui_stacked_container_to_pyobject (
    const mobius::core::ui::stacked_container &obj)
{
    return mobius::py::to_pyobject<core_ui_stacked_container_o> (
        obj, &core_ui_stacked_container_t);
}
...
pymobius_core_ui_stacked_container_from_pyobject (PyObject *value)
{
    return mobius::py::from_pyobject<core_ui_stacked_container_o> (
        value, &core_ui_stacked_container_t);
}
