...
func_has_resource (PyObject *, PyObject *args)
{
    ...
    {
        ret =
            mobius::py::pybool_from_bool (mobius::core::has_resource (arg_id));
    }
    catch (const std::exception &e)
    {
        mobius::py::set_runtime_error (e.what ());
...
func_get_resource (PyObject *, PyObject *args)
{
    ...
    try
    {
        ret = pymobius_core_resource_to_pyobject (
            mobius::core::get_resource (arg_id)
        );
    }
    catch (const std::exception &e)
    {
...
func_get_resource_value (PyObject *, PyObject *args)
{
    ...
    try
    {
        ret = mobius::core::get_resource_value<mobius::py::pyobject> (arg_id)
                  .new_reference ();
    }
    catch (const std::exception &e)
    {
