...
func_datasource_new_datasource_from_vfs (PyObject *, PyObject *args)
{
    ...
    try
    {
        arg_vfs = mobius::py::get_arg_as_cpp (
            args, 0, pymobius_core_vfs_vfs_from_pyobject);
    }
    ...
    {
        auto datasource =
            mobius::core::datasource::new_datasource_from_vfs (arg_vfs);
        ret = pymobius_core_datasource_datasource_to_pyobject (datasource);
    }
    catch (const std::exception &e)
    {
...
func_datasource_new_datasource_by_imagefile_path (PyObject *, PyObject *args)
{
    ...
    {
        auto datasource =
            mobius::core::datasource::new_datasource_by_imagefile_path (
                arg_path);
        ret = pymobius_core_datasource_datasource_to_pyobject (datasource);
    }
    catch (const std::exception &e)
...
func_datasource_new_datasource_by_imagefile_url (PyObject *, PyObject *args)
{
    ...
    {
        auto datasource =
            mobius::core::datasource::new_datasource_by_imagefile_url (arg_url);
        ret = pymobius_core_datasource_datasource_to_pyobject (datasource);
    }
    catch (const std::exception &e)
    {
...
func_datasource_new_datasource_by_ufdr_path (PyObject *, PyObject *args)
{
    ...
    {
        auto datasource =
            mobius::core::datasource::new_datasource_by_ufdr_path (arg_path);
        ret = pymobius_core_datasource_datasource_to_pyobject (datasource);
    }
    catch (const std::exception &e)
    {
...
func_datasource_new_datasource_by_ufdr_url (PyObject *, PyObject *args)
{
    ...
    {
        auto datasource =
            mobius::core::datasource::new_datasource_by_ufdr_url (arg_url);
        ret = pymobius_core_datasource_datasource_to_pyobject (datasource);
    }
    catch (const std::exception &e)
    {
