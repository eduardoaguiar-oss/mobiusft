...
static PyMethodDef module_methods[] = {
    {"get_current_folder", func_get_current_folder, METH_VARARGS,
     "Get current folder"},
    {"join_path", func_join_path, METH_VARARGS, "Join paths"},
    {"new_entry_by_path", func_new_entry_by_path, METH_VARARGS,
     "Create entry by path"},
    {"new_entry_by_url", func_new_entry_by_url, METH_VARARGS,
     "Create entry by URL"},
    {"new_file_by_path", func_new_file_by_path, METH_VARARGS,
     "Create file by path"},
    {"new_file_by_url", func_new_file_by_url, METH_VARARGS,
     "Create file by URL"},
    {"new_folder_by_path", func_new_folder_by_path, METH_VARARGS,
     "Create folder by path"},
    {"new_folder_by_url", func_new_folder_by_url, METH_VARARGS,
     "Create folder by URL"},
    {"new_path_from_win", func_new_path_from_win, METH_VARARGS,
     "Create path from Win path"},
    {"new_slice_reader", func_io_new_slice_reader, METH_VARARGS,
     "Create slice reader"},
    {"new_uri_from_path", func_new_uri_from_path, METH_VARARGS,
     "Create URI from path"},
    {"set_tempdir_path", func_set_tempdir_path, METH_VARARGS,
     "Set temporary directory path"},
    {"to_win_path", func_to_win_path, METH_VARARGS,
...
static PyModuleDef module_def = {
    ...
    "mobius.core.io",
    "Mobius Forensic Toolkit mobius.core.io module",
    -1,
    module_methods,
    nullptr,
    nullptr,
...
new_core_io_module ()
{
    ...
    // Add types
    module.add_type ("file", &core_io_file_t);
    ...
    module.add_type ("sequential_reader_adaptor",
                     &core_io_sequential_reader_adaptor_t);
