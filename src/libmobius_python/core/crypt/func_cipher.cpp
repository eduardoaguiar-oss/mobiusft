...
func_new_cipher_cbc (PyObject *, PyObject *args)
{
    ...
    try
    {
        auto cm = mobius::core::crypt::new_cipher_cbc (arg_cipher_id, arg_key,
                                                       arg_iv);
...
func_new_cipher_cbc_cts (PyObject *, PyObject *args)
{
    ...
    try
    {
        auto cm = mobius::core::crypt::new_cipher_cbc_cts (arg_cipher_id,
                                                           arg_key, arg_iv);
        ret = pymobius_core_crypt_cipher_to_pyobject (cm);
    }
    catch (const std::exception &e)
...
func_new_cipher_ctr (PyObject *, PyObject *args)
{
    ...
    try
    {
        arg_cipher_id = mobius::py::get_arg_as_std_string (args, 0);
        arg_key = mobius::py::get_arg_as_bytearray (args, 1);
        arg_cv = mobius::py::get_arg_as_bytearray (args, 2,
                                                   mobius::core::bytearray {});
    }
    catch (const std::exception &e)
    {
    ...
    try
    {
        auto cm = mobius::core::crypt::new_cipher_ctr (arg_cipher_id, arg_key,
                                                       arg_cv);
        ret = pymobius_core_crypt_cipher_to_pyobject (cm);
    }
    catch (const std::exception &e)
...
func_new_cipher_gcm (PyObject *, PyObject *args)
{
    ...
    try
    {
        auto cm = mobius::core::crypt::new_cipher_gcm (arg_cipher_id, arg_key,
                                                       arg_iv);
        ret = pymobius_core_crypt_cipher_to_pyobject (cm);
    }
    catch (const std::exception &e)
...
func_new_cipher_ige (PyObject *, PyObject *args)
{
    ...
    try
    {
        auto cm = mobius::core::crypt::new_cipher_ige (arg_cipher_id, arg_key,
                                                       arg_iv);
        ret = pymobius_core_crypt_cipher_to_pyobject (cm);
    }
    catch (const std::exception &e)
...
func_new_cipher_ofb (PyObject *, PyObject *args)
{
    ...
    try
    {
        auto cm = mobius::core::crypt::new_cipher_ofb (arg_cipher_id, arg_key,
                                                       arg_iv);
        ret = pymobius_core_crypt_cipher_to_pyobject (cm);
    }
    catch (const std::exception &e)
...
func_new_cipher_stream (PyObject *, PyObject *args)
{
    ...
    {
        auto cm =
            mobius::core::crypt::new_cipher_stream (arg_cipher_id, arg_key);
        ret = pymobius_core_crypt_cipher_to_pyobject (cm);
    }
    catch (const std::exception &e)
    {
