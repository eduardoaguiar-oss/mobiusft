...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
// @file evidence.cc C++ API <i>mobius.framework.model.evidence</i> class
//! wrapper
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_has_attribute (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
    std::string arg_id;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_get_attribute (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
    std::string arg_id;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_set_attribute (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
    std::string arg_id;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_set_attributes (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_remove_attribute (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
    std::string arg_id;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_get_attributes (framework_model_evidence_o *self, PyObject *)
{
    // Execute C++ function
    PyObject *ret = nullptr;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_has_tag (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
    std::string arg_name;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_set_tag (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
    std::string arg_name;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_set_tags (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_reset_tag (framework_model_evidence_o *self, PyObject *args)
{
    // Parse input args
    std::string arg_name;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
static PyObject *
tp_f_get_tags (framework_model_evidence_o *self, PyObject *)
{
    // Execute C++ function
    PyObject *ret = nullptr;
...
tp_getattro (PyObject *o, PyObject *name)
{
    ...
    try
    {
        ...
        if (ret == nullptr)
        {
            ...
            auto self = reinterpret_cast<framework_model_evidence_o *> (o);
