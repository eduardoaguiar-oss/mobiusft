#ifndef LIBMOBIUS_PYTHON_FRAMEWORK_MODEL_EVENT_HPP
#define LIBMOBIUS_PYTHON_FRAMEWORK_MODEL_EVENT_HPP
...
typedef struct
{
    PyObject_HEAD mobius::framework::model::event *obj;
} framework_model_event_o;
