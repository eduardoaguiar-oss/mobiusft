...
typedef struct
{
    PyObject_HEAD mobius::framework::evidence_loader *obj;
...
PyObject *pymobius_framework_evidence_loader_to_pyobject (
    const mobius::framework::evidence_loader &);
mobius::framework::evidence_loader
pymobius_framework_evidence_loader_from_pyobject (PyObject *);
