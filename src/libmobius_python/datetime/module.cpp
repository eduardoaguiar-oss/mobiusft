...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
// @brief  C++ API mobius.datetime module wrapper
...
{
  {
    "new_datetime_from_fat_time",
    func_new_datetime_from_fat_time,
    METH_VARARGS,
    "Create new datetime from FAT time"
  },
  {
...
static PyModuleDef module_def =
{
  ...
  "mobius.datetime",
  "Mobius Forensic Toolkit mobius.datetime module",
  -1,
  module_methods,
  nullptr,
  nullptr,
