...
{
  return PyObject_IsInstance (pyobj, (PyObject *) &decoder_sgml_tokenizer_t);
}
  ...
  try
    {
      ret = mobius::py::pytuple_from_cpp_pair (
               self->obj->get_token (),
               [](auto f){ return mobius::py::pylong_from_std_int32_t (static_cast <int> (f)); },
...
tp_new (PyTypeObject *type, PyObject *args, PyObject *)
{
  ...
  decoder_sgml_tokenizer_o *ret = reinterpret_cast <decoder_sgml_tokenizer_o *> (type->tp_alloc (type, 0));
...
PyTypeObject decoder_sgml_tokenizer_t =
{
  ...
  "mobius.decoder.sgml.tokenizer",             		// tp_name
  sizeof (decoder_sgml_tokenizer_o),           		// tp_basicsize
  0,                                       		// tp_itemsize
