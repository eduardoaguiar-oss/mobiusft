#ifndef MOBIUS_CORE_VFS_DATASOURCE_IMPL_DEVICE_HPP
#define MOBIUS_CORE_VFS_DATASOURCE_IMPL_DEVICE_HPP
...
public:
  ...
  explicit disk_impl_device (const mobius::core::pod::map&);
...
private:
  ...
  // @brief Device object
  mutable mobius::core::system::device device_;
