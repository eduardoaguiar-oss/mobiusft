#ifndef MOBIUS_CORE_REGISTRY_REGISTRY_DATA_IMPL_PSSP_HPP
#define MOBIUS_CORE_REGISTRY_REGISTRY_DATA_IMPL_PSSP_HPP
...
{
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
// @brief registry_data (subtype pssp) implementation class
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
