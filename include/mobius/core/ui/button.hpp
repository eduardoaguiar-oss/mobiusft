#ifndef MOBIUS_CORE_UI_BUTTON_HPP
#define MOBIUS_CORE_UI_BUTTON_HPP
...
class button : public widget
{
  public:
    ...
    explicit button (const mobius::core::ui::icon &);
    ...
    {
        set_icon (mobius::core::ui::new_icon_by_name (name));
    }
    ...
    {
        _impl<button_impl_base> ()->set_callback (
            event_id, mobius::core::functor (obj, f)
        );
    }
